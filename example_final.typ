...
--*FALTARÍA AGREGAR EL NÚMERO DE TRIANGULOS DE INPUT Y POLIGONOS DE SALIDA. PONER CRITERIOS DE CALIDAD FF Y CI*--
...
En este capítulo compararemos el algoritmo de disolución de mallas triangulizadas de Villarroel @Villarroel23 con el algoritmo de Polylla @Salinas22 sobre un conjunto de geometrías que se consideran representativas según complejidad topológica y morfológica, y como esto impacta a distintos criterios de calidad, como el Índice de Convexidad y el Factor de Forma. Para cada uno se medirá la cantidad de polígonos resultados luego de la aplicación de cada algoritmo, la calidad resultante y el uso de recursos computacionales.
...
--PARRAFOS SOBRE EXPERIMENTACIÓN--
